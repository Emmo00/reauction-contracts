...
import "../src/MultiCollectionMarketplace.sol";
...
contract DeployMarketPlace is Script {
    ...
    function run() external {
        ...
        MultiCollectionMarketplace multiCollectionMarketplace =
            new MultiCollectionMarketplace(config.usdc, config.usdcDecimals, config.admin, config.collectible);

        console.log("MultiCollectionMarketplace deployed at:", address(multiCollectionMarketplace));
